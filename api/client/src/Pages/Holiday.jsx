  ...
  const handleHoliday = async () => {
    try {
      await axios
        ...
        .then((response) => {
          if (response.data == "Holiday generated successfully !") {
            swal({
              title: "Holiday generated successfully !",
              icon: "success",
              button: "ok",
            });
  ...
  const handleEditHoliday = async () => {
    try {
      await axios
        ...
        .then((response) => {
          if (response.data == "Holiday has been updated") {
            swal({
  ...
  const handleDeleteHoliday = async () => {
    try {
      await axios
        ...
        .then((response) => {
          if (response.data == "Holiday has been deleted") {
            swal({
  ...
  return (
    <main id="main" className="main">
      ...
      <section className="section dashboard">
        {(user._doc.designation.toUpperCase() === "ADMIN" || user._doc.designation.toUpperCase() === "MANAGER") && (
          <div className="row">
            ...
            <table className="table table-striped">
              <thead>
                <tr>
                  ...
                  <th>Holiday Date</th>
                  <th>Description</th>
                  {(user._doc.designation.toUpperCase() === "ADMIN" ||
                    user._doc.designation.toUpperCase() === "MANAGER") && <th>Actions</th>}
                </tr>
              </thead>
              <tbody>
                {holidays.map((holiday, index) => (
                  <tr key={index}>
                    ...
                    {(user._doc.designation.toUpperCase() === "ADMIN" ||
                      user._doc.designation.toUpperCase() === "MANAGER") && (
                      <td>
                        <a
                          href=""
                          data-bs-toggle="modal"
