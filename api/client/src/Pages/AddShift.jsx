  ...
  const handleAddShift = async () => {
    try {
      await axios
        ...
        .then((response) => {
          if (response.data == "Shift generated successfully !") {
            swal({
              title: "Shift generated successfully !",
              icon: "success",
              button: "ok",
            });
  ...
  const handleEditShift = async () => {
    ...
    try {
      await axios
        ...
        .then((response) => {
          if (response.data == "Shift has been updated") {
            swal({
  ...
  const handleDeleteShift = async () => {
    ...
    try {
      await axios
        ...
        .then((response) => {
          if (response.data == "Shift has been deleted") {
            swal({
